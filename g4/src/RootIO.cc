...
void RootIO::OpenReactionFile()
{
  ...
  reaction_tree->Branch("sigma_165_total_b", &reaction_data.sigma_165_total_b, "sigma_165_total_b/D");
  ...
  reaction_tree->Branch("sigma_165_directdecay_sampling_b", &reaction_data.sigma_165_directdecay_sampling_b, "sigma_165_directdecay_sampling_b/D");
  ...
  reaction_tree->Branch("sequential_decay_fraction_165", &reaction_data.sequential_decay_fraction_165, "sequential_decay_fraction_165/D");
  ...
  reaction_tree->Branch("direct_decay_fraction_165", &reaction_data.direct_decay_fraction_165, "direct_decay_fraction_165/D");
  ...
  reaction_tree->Branch("scale_factor_165", &reaction_data.scale_factor_165, "scale_factor_165/D");
  ...
  reaction_tree->Branch("sigma_165_directdecay_b", &reaction_data.sigma_165_directdecay_b, "sigma_165_directdecay_b/D");
  ...
  reaction_tree->Branch("channel_probability_directdecay_165", &reaction_data.channel_probability_directdecay_165, "channel_probability_directdecay_165/D");
