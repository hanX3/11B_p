...
struct H11BReactionData
{
  ...
  G4int reaction_channel; // 0: Resonance165, 1: Resonance675, 2: Background3Alpha, 3: GammaCapture12C
  G4int background_mode;  // 2: PhaseSpace
  ...
  G4int h11b675_decay_model; // kept for backward compatibility; 0: isotropic, 1: Legendre A2/A4
  ...
  H11BReactionData()
      : event(0), e_alpha1(0), e_alpha2(0), e_alpha3(0), theta_lab_alpha1(0), theta_lab_alpha2(0), theta_lab_alpha3(0),
        ...
        h11b675_decay_model_used(0), enable_675_alpha1_secondary_angular_correlation(0),
        secondary_angular_model(0), secondary_a2_used(0), secondary_a4_used(0),
        ...
        sigma_165_sampling_b(0.), sigma_675_sampling_b(0.), sigma_background_sampling_b(0.),
        sigma_3alpha_sampling_total_b(0.), sigma_model_sum_b(0.), model_scale_factor(1.),
        cross_section_bias_factor(1.), background_bias_factor(1.), sigma_background_b(0.), sigma_3alpha_eval_b(0.), sigma_gamma_165_0_b(0.),
        ...
        channel_probability_gamma(0.), probability_gamma_165_0(0.), probability_gamma_165_1(0.),
